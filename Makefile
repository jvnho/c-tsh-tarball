...
tsh : tsh.o tar.o cd.o tsh_memory.o string_traitement.o function.o pwd.o mkdir.o ls.o rmdir.o rm.o simpleCommande.o bloc.o cp.o mv.o
...
mv.o: mv.c tsh_memory.h rm.h cp.h
